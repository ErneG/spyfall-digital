...
export const DEFAULT_LOCATIONS: LocationSeed[] = [
  ...
  { name: "Gas Station", edition: 2, roles: ["Attendant", "Customer", "Mechanic", "Cashier", "Car Washer", "Manager"] },
  { name: "Harbor Docks", edition: 2, roles: ["Longshoreman", "Ship Captain", "Customs Officer", "Fisherman", "Smuggler", "Harbor Master"] },
  { name: "Ice Hockey Stadium", edition: 2, roles: ["Hockey Player", "Coach", "Referee", "Spectator", "Goalie", "Commentator"] },
  { name: "Jail", edition: 2, roles: ["Prisoner", "Guard", "Warden", "Lawyer", "Snitch", "Visitor"] },
  ...
  { name: "Sightseeing Bus", edition: 2, roles: ["Tourist", "Bus Driver", "Tour Guide", "Pickpocket", "Photographer", "Souvenir Seller"] },
  { name: "Stadium", edition: 2, roles: ["Athlete", "Coach", "Referee", "Spectator", "Security Guard", "Vendor"] },
  { name: "Subway", edition: 2, roles: ["Commuter", "Busker", "Pickpocket", "Transit Officer", "Driver", "Tourist"] },
  { name: "Sushi Restaurant", edition: 2, roles: ["Sushi Chef", "Customer", "Waiter", "Manager", "Fish Supplier", "Food Critic"] },
  { name: "The United Nations", edition: 2, roles: ["Diplomat", "Translator", "Secretary General", "Security Guard", "Journalist", "Tourist"] },
